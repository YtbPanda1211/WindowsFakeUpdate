    ...
    var In = t => {
            ...
            X((() => {
                ...
                ct.current = N, at ? ft && (ut(dn.decode(ft).purposeConsents), at.update(ft, !1)) : (pt(new vn(379, 1, !0, {
                    getTCData: (t, e, n) => {
                        "boolean" != typeof e && (e.addtlConsent = ct.current, e.enableAdvertiserConsentMode = window ? .stpdCmpGlobals ? .googleConsentMode), t(e, n)
                    }
                })), dt(!0))
            }), [N]), X((() => {
                if (at) {
                            ...
                            children: [Wt(Qt, {
                                ...
                                handleChangeConsentValues: t => {
                                    const e = Object.keys(t),
                                        n = Object.keys(t[e]);
                                    "purposesConsent" == e ? i((s => ({ ...s,
                                        [n]: t[e][n]
                                    }))) : "purposesLegitimate" == e ? p((s => ({ ...s,
                                        [n]: t[e][n]
                                    }))) : "specialFeatures" == e ? d((s => ({ ...s,
                                        [n]: t[e][n]
                                    }))) : "vendorConsent" == e ? u((s => ({ ...s,
                                        [n]: t[e][n]
                                    }))) : "vendorLegitimate" == e ? m((s => ({ ...s,
                                        [n]: t[e][n]
                                    }))) : "nonGvlConsent" == e && b((s => ({ ...s,
                                        [n]: t[e][n]
                                    })))
                                },
                                purposesConsent: o,
